...
<head>
    ...
    <!-- Neo Brutalism Style · Raw edges · High contrast · Bold geometry -->
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        body {
            background: #f5f5f0;   /* off-white paper texture base */
        ...
        /* container: max width with brutalist grid */
        .container {
            max-width: 1200px;
            margin: 0 auto;
            background: #f5f5f0;
        ...
        /* NEO BRUTALISM CORE: sharp borders, hard shadows, primary colours */
        .brutal-card {
            background: #ffffff;
        ...
        /* header block (replaces Capsule wave with brutalist shapes) */
        .brutal-header {
            background: #111;
            color: #ffdd00;
            padding: 2rem 1.5rem;
        ...
        /* typing effect replacement with static bold neo-brutal text */
        .typing-static {
            background: #000;
            color: #00ffcc;
        ...
        /* skill grid — raw, no rounded edges */
        .skill-grid {
            display: flex;
            flex-wrap: wrap;
            gap: 0.7rem;
        ...
        /* project table style — brutalist grid */
        .project-table {
            width: 100%;
        ...
        /* GitHub trophies area: brutalist container */
        .trophy-container {
            background: #fff;
...
<div class="container">
    ...
    <!-- Brutalist header equivalent to wave + title -->
    <div class="brutal-header">
        <h1>JIBIN WILSON</h1>
        <p>B.Tech CSE | Full-Stack Developer | Tech Leader</p>
    </div>

    <!-- Static Typing Animation styled as Neo Brutalist label (no JS, pure bold) -->
    ...
    <!-- Key Projects Table (Neo Brutalism) -->
    <div class="brutal-card">
    ...
    <!-- GitHub Trophies with brutalist container -->
    <div class="trophy-container">
        <div style="font-weight: 800; margin-bottom: 1rem; text-transform: uppercase; font-size: 1.2rem;">🏆 GitHub Trophies (neo-brutal style)</div>
    ...
    <!-- GitHub Activity Calendar / Heatmap with brutalist frame -->
    ...
    <div class="brutal-card" style="text-align: center;">
        ...
        <!-- small note: original styling uses same content -->
    </div>

    <!-- Footer brutal wave imitation by thick border -->
    <footer>
...
<!-- capsule render replacement removed, full neo-brutal design with original data -->
</body>
</html>
